...
| `artifact_export_postgresql` | No | `true` | Include PostgreSQL dumps in artifact |
| `artifact_import_postgresql` | No | `true` | Restore PostgreSQL dumps on import (auto-skipped if artifact has no dumps) |
